                            ...
                            <div class="small-box dbox--color-4">
                                <div class="inner">
                                    <h1 style="color:aliceblue"><b>
                                            ...
                                            $query = "SELECT COUNT(*) AS total_entries FROM reached_food ";
                                    ...
                                    <p style="color:aliceblue"><b>Remaining Food Verification</b></p>
                                </div>
                                <div class="icon">
                            ...
                            <div class="small-box dbox--color-5">
                                <div class="inner">
                                    <h1 style="color:aliceblue"><b>
                                            ...
                                            $query = "SELECT COUNT(*) AS total_entries FROM pickedup_book  where `pickedup_book`.`pickedup_date`=  $current_date";
                                            $result = $conn->query($query);
                                    ...
                                    <p style="color:aliceblue"><b>Remaining Book Verification</b></p>
                                </div>
                                <div class="icon">
                                    <i class="ionicons ion-ios-book-outline"></i>
                                </div>
                                <a href="book_verification" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
