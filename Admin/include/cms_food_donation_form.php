...
<head>
    ...
    <title>Noble Causes-CMS-Food Donation Form</title>
    <style>
        .type-option {
            display: flex;
...
<body>
    ...
    <div class="cms_book_donation_page_content">
        <div class="header">
            <header>
                <div class="cms_book_donation_page_title">
                    <h1>Noble Causes - CMS Food Donation Page</h1>
                    <ul class="navigation">
                        ...
                        <li class="navigation-item">
                            <a href="../include/cms_food_donation_form">CMS Food Donation Form</a>
                        </li>
                        <li class="navigation-icon">
                            <i class="bx bx-chevron-right dropdown"> </i>
                        </li>
        ...
        <form action="../controller/cmd_fdf" method="POST">
                    ...
                    <div class="type-option">
                        <div class="option">
                            ...
                            <label for="check-fdf_form1"><img src="../NC_Images/<?php
                                                                                require_once('../config/db_connection.php');
                                                                                $sql = "SELECT * FROM cms_fdf WHERE fdf_id = 1";
                                                                                $result = mysqli_query($conn, $sql);
                        ...
                        <div class="option">
                            ...
                            <label for="check-peoples"><img src="../NC_Images/<?php
                                                                                require_once('../config/db_connection.php');
                                                                                $sql = "SELECT * FROM cms_fdf WHERE fdf_id = 2";
                                                                                $result = mysqli_query($conn, $sql);
                                                                                $row = mysqli_fetch_assoc($result);
                                                                                $path = $row['fdf_img'];
                                                                                echo $path;
