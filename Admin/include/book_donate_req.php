...
<head>
    ...
    <title>Noble Causes-Donated Books</title>
    <style>
    .btn {
        display: block;
        display: flex;
        ...
        <div class="book_donate_req_content">
            <header>
                <div class="book_donate_req_content_title">
                    ...
                    <ul class="navigation">
                        ...
                        <li class="navigation-item">
                            <a href="../include/book_donate_req">Donated Book</a>
                        </li>
                        <li class="navigation-icon">
                            <i class="bx bx-chevron-right dropdown"> </i>
                        </li>
            ...
            <table class="table align-middle mb-0 bg-white" cellspacing="30%" cellpadding="0" row-gap-sm-2>
                ...
                ?>
                    ...
                    $int = 1;
                    $query = "SELECT * FROM donate_book WHERE `donate_book`.`status` = 'pending' ORDER BY book_id ASC";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><form action="../controller/view_details?view=cabdsd&id=<?php echo $book_id; ?>" method="POST">                            
                            <input type="hidden" name="book_id" value="<?php echo $book_id; ?>" >
                            <input type="submit" name="view" value="view">                           
                        </form></td>                            
                        <td><form action="../controller/approve_book_req" method="POST">                            
                            <input type="hidden" name="book_id" value="<?php echo $book_id; ?>">
