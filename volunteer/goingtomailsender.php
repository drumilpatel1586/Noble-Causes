...
$sql43 = "SELECT `name`,`email` FROM `user_login` WHERE `user_login`.`user_id`='$d_u_id'";
...
$body =  'Dear '.$user_name.',
<br>
<p>Volunter are out for pickedup your donation, he will reach at you in approximately 30 min</p>
'; 
